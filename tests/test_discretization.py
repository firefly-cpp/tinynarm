...
class TestSportydatagenDiscretizationA(TestCase):
    ...
    def test_discrete_classes(self):
        ...
        duration = ['interval_1', 'interval_1', 'interval_3', 'interval_3', 'interval_3']
        average_hr = ['interval_2', 'interval_2', 'interval_3', 'interval_2', 'interval_1']
...
class TestSportydatagenDiscretizationB(TestCase):
    ...
    def test_intervals_duration(self):
        ...
        intervals = [54.0, 58.026666666, 62.053333332, 66.079999998, 70.106666664, 74.13333333]
        interval_duration = self.dataset.feat[0].intervals
        assert intervals == interval_duration, "Not correct interval for duration feature"
    ...
    def test_discrete_classes_scenarioB(self):
        ...
        duration = ['interval_1', 'interval_1', 'interval_4', 'interval_5', 'interval_5']
        average_hr = ['interval_2', 'interval_3', 'interval_5', 'interval_2', 'interval_1']
