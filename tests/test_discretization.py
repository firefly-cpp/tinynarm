...
class TestSportydatagenDiscretizationA(TestCase):
    ...
    def test_discrete_classes(self):
        ...
        duration = [
            '[54.0,60.71111111]',
            '[54.0,60.71111111]',
            '[67.42222222,74.13333333]',
            '[67.42222222,74.13333333]',
            '[67.42222222,74.13333333]'
        ]
        average_hr = [
            '[114.33333333333333,131.66666666666666]',
            '[114.33333333333333,131.66666666666666]',
            '[131.66666666666666,149.0]',
            '[114.33333333333333,131.66666666666666]',
            '[97.0,114.33333333333333]'
        ]
...
class TestSportydatagenDiscretizationB(TestCase):
    ...
    def test_discrete_classes_scenarioB(self):
        ...
        duration = [
            '[54.0,58.026666666]',
            '[54.0,58.026666666]',
            '[66.079999998,70.106666664]',
            '[70.106666664,74.13333333]',
            '[70.106666664,74.13333333]'
        ]
        average_hr = [
            '[107.4,117.8]',
